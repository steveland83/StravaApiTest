    ...
    internal sealed class Configuration : DbMigrationsConfiguration<StravaApiTest.DAL.AppDbContext>
    {
        ...
        protected override void Seed(StravaApiTest.DAL.AppDbContext context)
        {
            ...
            context.Users.AddOrUpdate(p => p.Id,
                ...
                new UserEntity() { Id = 552173, AccessToken = "4051442f80f86866fb089224c77204c38e09a6fd", FirstName = "Seed", LastName = "Data" },
                new UserEntity() { Id = 3646290, AccessToken = "4d245cfaba1abf8ea9cba02746f7495cf2e61002", FirstName = "Seed", LastName = "Data" },
                new UserEntity() { Id = 6601020, AccessToken = "9a90802d8392573b941579eca0ed52e7ea314b17", FirstName = "Seed", LastName = "Data" }
                );
